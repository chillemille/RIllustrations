---
title: "Instructions_GeneID_Conversion_DuplicatesRemoval"
...
- clusterProfiler: This library offers tools for the statistical analysis visualization of gene data. We use its function for the conversion of the gene IDs from one format to another. 

- org.Hs.eg.db: !!!!!!!!!!!!!!!!!!!!!!!!!!!!! For human, must be adapted for other organisms 
