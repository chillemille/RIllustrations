...
################################
# (i) Conversion of the gene IDs from Enembl IDs to HGNC symbols using clusterProfiler
################################
...
########
# CASE 2: multiple ENSEMBL IDs are mapped to single HGNC symbol
########
...
##################################
# (iii) remove duplicated gene IDs
##################################
...
#case 1: single ENSEMBL ID that is mapped to multiple HGNC gene symbols 
...
# We note proceed with differential expression analysis 
...
# (ii) DESeq2
# (iii) edgeR, 
# we will also three gene rankings, one for each of these three methods 
...
path_conditions <- "./Input_Objects_GSEAPreranked/gene_ranking.txt"
