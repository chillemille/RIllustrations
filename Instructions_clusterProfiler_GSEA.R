...
################################################################################
### (i) Gene set database KEGG #################################################
################################################################################

# as described above, we proceed with the genes in the Entrez gene ID format 
# when working with the gene set database KEGG 
...
# for DESEq2, we additionally need to load the object dds_Ensembl from 
# "Instructions_Differential_Expression_Analysis.R": 
load("./Results_Differential_Expression_Analysis/dds_Entrez.Rdata")
...
# (i) for gene set database KEGG: change exponent to value 2  
...
# (ii) for gene set database GO: change exponent to value 2 
