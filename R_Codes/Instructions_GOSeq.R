...
# DE_results <- DE_results_edgeR_Ensembl
...
# expressed genes which is typically required by ORA
...
# expressed genes)
# (ii) names that correspond to the given gene IDs
...
# run
# -> this can be deactivated by adding the function argument plot.fit = FALSE
...
###############################################################################
# change 2: Include genes that are no member of any gene set in calculation ###
########### of p-value ########################################################
###############################################################################
