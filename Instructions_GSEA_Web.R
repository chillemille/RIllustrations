...
# after exporting the input object(s), some further preprocessing is required
# -> this can be done in Excel and in accordance with the following instructions: 
...
load("./Results_RNASeq_Transformation/expression_data_voomtransformed_Ensembl.Rdata")
...
path_measurements  <- "./Input_Objects_GSEA_web/expression_data_transformed.txt"
...
path_conditions <- "./Input_Objects_GSEA_web/sample_conditions_prepared.txt"
