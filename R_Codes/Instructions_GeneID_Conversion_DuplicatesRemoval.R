...
# create folder "Results_GeneID_Conversion_DuplicatesRemoval" to eventually
# contain the .Rdata filed created in this script 
dir.create("./data/Results_GeneID_Conversion_DuplicatesRemoval")
...
##############################################
  ...
  # there is no recommended way to proceed, i.e. no common approach presented in an official scientific publications,
  ...
  # this is the simplest approach among the three
    ...
    exprdat_filterByExpr_dupl1<-merged_expression_data_filterByExpr[!duplicated(merged_expression_data_filterByExpr$ENTREZID),]
    ...
    # inspect dimension of resulting gene expression data set
    ...
    ############
      ...
      # - number of genes in merged_expression_data_filterByExpr has decreased to 9537
      # -> this is directly caused by the circumstance that typically, not all initial (Ensembl) gene IDs can be
      # converted to the required (Entrez) gene ID
      # - the expression data set has been extended by two columns:
      # (1.) the very last column (here called "ENTREZID" containing the converted (Entrez) gene ID
      ...
      # there is no recommended way to proceed, i.e. no common approach presented in an official scientific publication,
      # but instead several approaches suggested by users in corresponding user platforms,
...
save(exprdat_filter_conv_filterByExpr, file = "./data/Results_GeneID_Conversion_DuplicatesRemoval/exprdat_filter_conv_filterByExpr.Rdata")
save(exprdat_filter_conv_DESeq2, file = "./data/Results_GeneID_Conversion_DuplicatesRemoval/exprdat_filter_conv_DESeq2.Rdata")
