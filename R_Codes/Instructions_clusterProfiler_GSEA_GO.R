...
load("./data/Results_Differential_Expression_Analysis/dds_Ensembl.Rdata")
  ...
  ################################################################################
    ...
    # required input object for clusterProfiler: "order ranked geneList",
  ...
  # As mentioned in the paper, RNA-Seq data consists (in its raw form) of count
  ...
  #########
  # step 3: Generate the ranked list of the genes based on the results of differential
  ######### expression analysis
  ...
  # for the purpose of simplicity, we work with the ranking generated using limma
