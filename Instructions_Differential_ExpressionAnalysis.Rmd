---
title: "Instructions Differential Expression Analysis"
...
Here, the information on the condition of each sample is the only column in the data frame, while the samples themselves are stored in the rownames. However, if further variables (such as batch effects) are to be controlled for, the corresponding variables must additionally be added to coldata. 
