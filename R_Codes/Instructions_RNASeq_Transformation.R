...
# create the folder "Results_RNASeq_Transformation" to eventually contain the
# .Rdata files resulting from this script
dir.create("./data/Results_RNASeq_Transformation")
...
save(expression_data_voomtransformed_Entrez, file = "./data/Results_RNASeq_Transformation/expression_data_voomtransformed_Entrez.Rdata")
save(expression_data_voomtransformed_Ensembl, file = "./data/Results_RNASeq_Transformation/expression_data_voomtransformed_Ensembl.Rdata")

# save variance transformed RNA-Seq data
save(expression_data_vsttransformed_Entrez, file = "./data/Results_RNASeq_Transformation/expression_data_vsttransformed_Entrez.Rdata")
save(expression_data_vsttransformed_Ensembl, file = "./data/Results_RNASeq_Transformation/expression_data_vsttransformed_Ensembl.Rdata")
