...
# first of all, we create the folder "data" to eventually contain the resulting .Rdata
# objects of each individual .R-instructions file 
dir.create("./data")

# within the folder data, we create the folder "Results_PreFiltering"
dir.create("./data/Results_PreFiltering")
...
# (i) for each gene, if it contains sufficient cpm in enough samples
...
# for differential expression analysis and in some steps, we cannot work with a DGEList object
...
save(expression_data_filterDESeq2, file = "./data/Results_PreFiltering/expression_data_filterDESeq2.Rdata")
# save gene expression data set filtered with edgeR's approach
save(expression_data_filterByExpr, file = "./data/Results_PreFiltering/expression_data_filterByExpr.Rdata")
