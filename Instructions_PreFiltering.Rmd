---
title: "Instructions_PreFiltering"
...
- tweeDESeqCountData: This library contains a collection of RNA-Seq data sets from which we use one for illustration
- edgeR: this library analyses high dimensional count data resulting from RNA sequencing and is in our context particularly used for differential expression analysis (see file "Instructions_Differential_Expression_Analysis")
